...
window.onload = async () =>
{
    ...
    let y = d3.scaleBand().domain(d3.range(shownBarsNumber + 1)).rangeRound([margin.top, margin.top + barSize * (shownBarsNumber + 1 + 0.1)]).padding(0.1);
    ...
    function axis(svg)
    {
        ...
        const axis = d3.axisTop(x)
            .ticks(width / 160)
            .tickSizeOuter(0)
            .tickSizeInner(-barSize * (shownBarsNumber + y.padding()));
